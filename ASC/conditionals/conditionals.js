...
if (item== "jacket"){
    health+=20;
    money-=40;
    console.log("You just brought a jacket");
}
else if (item== "candy"){
    money-=10;
    console.log("You just brought candy");
}
else if (item== "paint"){
    money-=30;
    console.log("You just brought paint");
}
else if (item == "hammer"){
    money-=70;
    console.log("You just brought a hammer");
}
else {
    console.log("You brought nothing");
}
...
//      - reduce "money" to 0
if (choice=="")(randomperson=''){money==0;}
console.log("You shut down due to inactivity and get robbed of all your money");}
